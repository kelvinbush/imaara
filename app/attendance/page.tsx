    ...
    >
      ...
      <SignedIn>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 space-y-6">
          ...
          {/* Gender Tabs */}
          <div className="flex items-center gap-6 border-b border-white/20">
            {([
              { key: "all", label: "All" },
              { key: "male", label: "Male" },
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mt-4">
            <input
              ...
              className="w-full md:max-w-md px-4 py-2 rounded-full border border-zinc-200 bg-white/70 backdrop-blur text-sm outline-none focus:ring-2 focus:ring-amber-300"
            />
          ...
          {searched.length === 0 ? (
            ...
            <div className="overflow-x-auto rounded-2xl bg-white/60 backdrop-blur-xl">
                      ...
                      <tr key={m.memberId as any} className="hover:bg-white/35 transition-colors">
                        ...
                        <td className="px-5 py-3 text-sm rounded-r-xl">
                          <div className="flex justify-end">
                            <button
                              className={`px-3 py-1.5 rounded-full text-sm font-light transition-colors cursor-pointer hover:scale-105 transition-transform ${
                                wasPresentToday
                            ...
                            <button
                              className="ml-2 px-3 py-1.5 rounded-full text-sm font-light bg-white/60 text-zinc-900 hover:bg-white cursor-pointer"
                              onClick={() => {
                                setEditingMember({
          ...
          {searched.length > 0 && (
            <div className="flex items-center justify-between text-sm text-zinc-700">
              ...
              <div className="flex items-center gap-2">
                <button
                  className="px-3 py-1.5 rounded-full bg-white/70 backdrop-blur border border-zinc-200 disabled:opacity-50"
